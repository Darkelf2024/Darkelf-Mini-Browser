...
from PySide6.QtGui import QPalette, QColor, QKeySequence, QShortcut, QAction, QGuiApplication, QActionGroup, QIcon, QPixmap, QPainter, QFont, QCursor, QPainterPath, QKeyEvent, QTextCursor
...
class Darkelf(QMainWindow):
    ...
    def init_shortcuts(self):
        ...
        # --- Bookmark shortcuts, etc. can be added as desired ---
