...
class Darkelf(QMainWindow):
    ...
    def create_menu_bar(self):
        ...
        about.addAction("Privacy Policy", lambda: self.create_new_tab("https://github.com/Darkelf2024/Darkelf-Browser/blob/main/Privacy%20Policy.md"))
        about.addAction("Terms of Service", lambda: self.create_new_tab("https://github.com/Darkelf2024/Darkelf-Browser/blob/main/Terms.md"))
