...
from PySide6.QtGui import QPalette, QColor, QKeySequence, QShortcut, QAction, QGuiApplication, QActionGroup, QIcon, QPixmap, QPainter, QFont, QCursor
...
class CanvasProtectionMixin:
    """
    Mixin for strong canvas fingerprinting protection.
    Call self.inject_canvas_protection() in your page constructor.
    This version injects pixel noise and tampering so Browserleaks shows the green checkmark.
    """
    def inject_canvas_protection(self):
        script = r"""
        (() => {
            // Add pixel noise to ImageData
            ...
            // Patch toDataURL to add noise before export
            const origToDataURL = HTMLCanvasElement.prototype.toDataURL;
            HTMLCanvasElement.prototype.toDataURL = function() {
                const ctx = this.getContext("2d");
                if (ctx) {
                    // Add pixel noise directly to canvas
                    ...
                    // Optionally restore original pixels here if needed
                    return result;
                }
                return origToDataURL.apply(this, arguments);
            };

            // Patch toBlob to add noise before export
            ...
            // Patch getContext to always spoof as 2d (block WebGL)
