...
from PySide6.QtGui import QPalette, QColor, QKeySequence, QShortcut, QAction, QGuiApplication, QActionGroup, QIcon, QPixmap, QPainter, QFont, QCursor, QPainterPath
...
class DarkelfCompatSandbox:
    ...
    def inject_extra_spoofing(self, page):
        ...
        ua_script = """
        (() => {
            Object.defineProperty(navigator, 'userAgent', { get: () => "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:102.0) Gecko/20100101 Firefox/78.0" });
